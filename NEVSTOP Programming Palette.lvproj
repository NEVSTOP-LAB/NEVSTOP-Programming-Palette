	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="user.lib" Type="Folder">
				...
				<Item Name="String to 1D Array_csm.vi" Type="VI" URL="/&lt;userlib&gt;/_NEVSTOP/Communicable State Machine(CSM)/Utility/_openG/String to 1D Array_csm.vi"/>
				<Item Name="String to Boolean_csm.vi" Type="VI" URL="/&lt;userlib&gt;/_NEVSTOP/Communicable State Machine(CSM)/addons/API-String-Arugments-Support/_Support/String to Boolean_csm.vi"/>
				<Item Name="String To Float_csm.vi" Type="VI" URL="/&lt;userlib&gt;/_NEVSTOP/Communicable State Machine(CSM)/addons/API-String-Arugments-Support/_Support/String To Float_csm.vi"/>
				<Item Name="String To Indexed Enum_csm.vi" Type="VI" URL="/&lt;userlib&gt;/_NEVSTOP/Communicable State Machine(CSM)/addons/API-String-Arugments-Support/_Support/String To Indexed Enum_csm.vi"/>
